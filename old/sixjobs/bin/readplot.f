      program readplot
      IMPLICIT none
      integer i,ich,ich1,ich2,ich3,ichl,icount,iend,iel,iel2,iin,ilost
      integer itest,j,m,ment,ntlmax,ntlint,tl
      DOUBLE PRECISION achaos,achaos1,al,alost1,alost2,alost3,amax,amin
      DOUBLE PRECISION dummy,elhc,einj,fac,fac1,fac2,fac3,fac4,fac5
      DOUBLE PRECISION pieni,rad,rad1,rat,sigma,sumda,zero
      character*20 title
      character*8192 ch
      parameter(ment=1000)
