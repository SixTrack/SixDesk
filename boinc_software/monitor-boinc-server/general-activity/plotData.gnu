...
set xtics 3600 rotate by 90 right
...
plot \
     ...
     ''               index 0 using 2:($3/1000*M) with linespoints pt 7 ps 1 lt 2 lw 1 lc rgb 'green' title 'ready to send '.gprintf('(M=%.1f)',1./M),\
...
plot \
     ...
     ''        index 0 using 2:($3/1000*M) with linespoints pt 7 ps 1 lt 2 lw 1 lc rgb 'green' title 'unsent '.gprintf('(M=%.1f)',1./M),\
